...
<html lang="en">
	...
	<body>
		<h2><p><a href="{{authorize_url}}"><img src="/static/images/twitter2.png" height="42" width="42" align="left"></a><font COLOR=white>: Twittea con nosotros clickeando en el símbolo.  </font></p> <a class="twitter-share-button" href="https://twitter.com/intent/tweet?text=Buenas Twitter, estoy echándole un vistazo al perfil de: {{nick}}, gracias a la web http://gamesapi-hezparust.rhcloud.com/" data-size="large">Tweet directo</a></h2>
