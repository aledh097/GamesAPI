...
<html lang="en">
	...
	<body>
		<p><a href="{{authorize_url}}"><img src="http://www.redunonet.co/twitter.png" height="42" width="42" align="left"></a><h2><font COLOR=white>: Comparte el resultado en Twitter clickeando en el símbolo.  </h2></font></p>
