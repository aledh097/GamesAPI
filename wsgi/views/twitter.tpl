...
<html lang="en">
	...
	<body>
		...
		<a href="/"><img class="inicio" src="http://www.clker.com/cliparts/0/d/H/0/t/i/home-logo-hi.png" onmouseover="this.style.opacity=1;this.filters.alpha.opacity='100';" onmouseout="this.style.opacity=0.8;this.filters.alpha.opacity='20';"/></a>
	</body>	
</html>
